...
public class CatService {
    ...
    @Transactional
    public CatDTO updateCat(CatDTO catDTO, String currentUserLogin) {
        Cat cat = new Cat();
        ...
        Owner user = ownerRepository.findByLogin(currentUserLogin).orElseThrow(() -> new EntityNotFoundException("owner not found"));

        if (catDTO.getOwnerId() != user.getID()) {
