...
public class ExamAcademicSubjectsFactory : IAcademicSubjectFactory
{
    public AcademicSubjectBase CreateAcademicSubject(Repository<Labwork> labs, Repository<LectionMaterial> lecs, string name, User autor, int score)
    {
        ...
        return ExamAcademicSubject.Builder.AddExamScore(score).AddName(name).AddAutor(autor).Build();
    }
}
